    ...
    <div className="p-8 space-y-8 font-sans">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="px-2 py-0.5 rounded-full bg-green-500/10 border border-green-500/20 text-[10px] font-bold text-green-400 uppercase tracking-widest">
            Active
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-2 text-xs text-white placeholder:text-white/20 focus:border-[#4ade80]/40 outline-none w-64 transition-all"
            />
          </div>
          <button className="p-2 rounded-lg bg-white/5 border border-white/10 text-white/40 hover:text-white transition-all">
            <Download className="w-4 h-4" />
          </button>
          <button className="px-4 py-2 bg-white text-black rounded-lg text-xs font-bold flex items-center gap-2 hover:scale-105 transition-all">
      ...
      <div className="flex items-center gap-6 border-b border-white/5 pb-4">
        <div className="flex items-center gap-4">
          <button className="text-[11px] font-bold text-white border-b-2 border-white pb-4 transition-all">Companies</button>
          <button className="text-[11px] font-bold text-white/40 hover:text-white pb-4 px-2 transition-all">Deals</button>
          <button className="text-[11px] font-bold text-white/40 hover:text-white pb-4 px-2 transition-all">Forecast</button>
        </div>
        <div className="flex items-center gap-2 ml-auto">
          <span className="text-[10px] uppercase font-bold text-white/20 tracking-widest">Sort by</span>
          <select className="bg-transparent text-[10px] font-bold text-white/60 outline-none cursor-pointer">
