                      ...
                      <div className="p-8 space-y-10">
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-white/5">
                          ...
                          <button
                            ...
                            className="flex items-center gap-2 px-10 py-3 bg-[#10B981] text-black font-black text-[10px] uppercase tracking-[0.2em] rounded-xl hover:bg-[#0ea572] transition-all disabled:opacity-40"
                          >
                            {saving === agent.id
                              ? <div className="w-3.5 h-3.5 border-2 border-black/30 border-t-black rounded-full animate-spin" />
                              : saved === agent.id
                      ...
                      <div className="p-8 space-y-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-[9px] font-mono text-white/30">{skills.length} / {maxSkills} skills configurés</p>
                          </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {[
                            ...
                            <div key={label} className="bg-[#0D0D0D] border border-white/5 rounded-xl p-5">
                              ...
                              <p className="text-[11px] font-mono text-white/60 truncate">{value}</p>
                            </div>
                          ))}
                        </div>

                        <p className="text-[8px] font-mono text-white/20 text-center">Les données de performance se mettent à jour en temps réel depuis client_agent_tasks</p>
                      </div>
                    )}
